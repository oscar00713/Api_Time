...
class AppointmentsweekController extends Controller
{
    /**
     * Obtiene todas las citas de una semana en adelante empezando del día seleccionado
     * Si no se elige Employee, agrupa los turnos por día mostrando la cantidad de turnos por día
     * Permite filtrar por servicio, empleado, cliente y estado
     *
     * @param Request $request
     * @return \Illuminate\Http\JsonResponse
     */
    public function getAppointmentsByWeek(Request $request)
    {
        ...
        $endDate = Carbon::parse($validated['start_date'])->addDays(7)->endOfDay(); // Por defecto 7 días
